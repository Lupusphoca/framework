namespace PierreARNAUDET.Modules.DOT.RectTransforms
{
    ...
    public class SizeDeltaAnchorPosRectTransformDOT : URectTransformDOT
    {
        [Data]
        ...
        public void DOSizeDelta(Vector2 newEndValue, float newDuration, bool newSnapping)
        {
        ...
        public void DOSizeDelta()
        {
            rectTransform.DOSizeDelta(endValue, duration, snapping);
            _event.Invoke();
        }
    }
}