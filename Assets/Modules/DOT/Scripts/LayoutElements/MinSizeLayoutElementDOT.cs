namespace PierreARNAUDET.Modules.DOT.LayoutElements
{
    ...
    public class MinSizeLayoutElement : ULayoutElementDOT
    {
        [Data]
        ...
        public void DOMinSize(Vector2 newEndValue, float newDuration, bool newSnapping)
        {
        ...
        public void DOMinSize()
        {
            layoutElement.DOMinSize(endValue, duration, snapping);
            @event.Invoke();
        }
    }
}